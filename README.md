...
2026-09-26起，預設本金為100,000元，從零持股開始的紙上帳戶啟用日固定於 `race-five-stock-lab/champion_account_config.json`，每日續跑不重設。首頁預設「明日操作」，可切換10萬元歷史模型；歷史模型收益與新帳戶收益獨立。預估股數只採已知行情與手續費／容量限制，賣款未交割不計可用資金。「已閱讀」僅本機標記，並非已成交。
