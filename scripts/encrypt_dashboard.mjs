...
writeFileSync('data/dashboard.secure.json',JSON.stringify({version:1,data_version:dataVersion,algorithm:'AES-256-GCM',envelopes},null,2));
console.log(JSON.stringify({output:'data/dashboard.secure.json',data_version:dataVersion,envelopes:envelopes.length,plaintext_bytes:source.length}));
